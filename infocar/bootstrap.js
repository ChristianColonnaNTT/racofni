...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Infocar.controller.HomeController": [],
  "Infocar.controller.MainController": [],
  "Infocar.controller.MenuController": [],
  "Infocar.controller.PhotoFullScreenController": [],
  "Infocar.controller.RicercaNuovoController": [],
  "Infocar.controller.RicercaStockController": [],
  "Infocar.controller.RicercaUsatoController": [],
  "Infocar.controller.TopBarController": [],
  "Infocar.model.AlimentazioneModel": [],
  "Infocar.model.AllestimentoModel": [],
  "Infocar.model.AnnoImmatricolazioneModel": [],
  "Infocar.model.CarrozzeriaModel": [],
  "Infocar.model.ColoreEsternoModel": [],
  "Infocar.model.ColoreInternoModel": [],
  "Infocar.model.DatiTecniciModel": [],
  "Infocar.model.DestinazioneModel": [],
  "Infocar.model.DettaglioVeicoloNuovoModel": [],
  "Infocar.model.DettaglioVeicoloUsatoModel": [],
  "Infocar.model.EquipaggiamentoModel": [],
  "Infocar.model.EstremiPrezzoKmModel": [],
  "Infocar.model.GraficoInfoVeicoloModel": [],
  "Infocar.model.InfoVeicoloNuovoModel": [],
  "Infocar.model.InfoVeicoloStockModel": [],
  "Infocar.model.InfoVeicoloUsatoModel": [],
  "Infocar.model.InformEquipDettVeicoloNuovoModel": [],
  "Infocar.model.ListinoModel": [],
  "Infocar.model.LogicaModel": [],
  "Infocar.model.MarcaModel": [],
  "Infocar.model.ModelloModel": [],
  "Infocar.model.OrdinamentoModel": [],
  "Infocar.model.ProvenienzaModel": [],
  "Infocar.model.StringModel": [],
  "Infocar.model.UtenteModel": [],
  "Infocar.model.VeicoloStockModel": [],
  "Infocar.store.AlimentazioneRicercaNuovoStore": [],
  "Infocar.store.AlimentazioneRicercaStockStore": [],
  "Infocar.store.AlimentazioneRicercaUsatoStore": [],
  "Infocar.store.AllestimentoRicercaNuovoStore": [],
  "Infocar.store.AllestimentoRicercaUsatoStore": [],
  "Infocar.store.AnnoImmatricolazioneStore": [],
  "Infocar.store.CarrozzeriaRicercaNuovoStore": [],
  "Infocar.store.CarrozzeriaRicercaStockStore": [],
  "Infocar.store.CarrozzeriaRicercaUsatoStore": [],
  "Infocar.store.ColoreEsternoDettVeicoloUsatoStore": [],
  "Infocar.store.ColoreInternoDettVeicoloUsatoStore": [],
  "Infocar.store.DatiTecniciInfoVeicoloNuovoStore": [],
  "Infocar.store.DatiTecniciInfoVeicoloStockStore": [],
  "Infocar.store.DatiTecniciInfoVeicoloUsatoStore": [],
  "Infocar.store.DestinazioneStore": [],
  "Infocar.store.EquipClustersDettVeicoloNuovoStore": [],
  "Infocar.store.EquipDettVeicoloNuovoStore": [],
  "Infocar.store.EquipDettVeicoloUsatoStore": [],
  "Infocar.store.EquipInfoVeicoloNuovoStore": [],
  "Infocar.store.EquipInfoVeicoloUsatoStore": [],
  "Infocar.store.EquipMontatiInfoVeicoloStockStore": [],
  "Infocar.store.EquipSelAutomaticaDettVeicoloNuovoStore": [],
  "Infocar.store.EquipSerieInfoVeicoloStockStore": [],
  "Infocar.store.GraficoInfoVeicoloNuovoStore": [],
  "Infocar.store.GraficoInfoVeicoloUsatoStore": [],
  "Infocar.store.InformEquipDettVeicoloNuovoStore": [],
  "Infocar.store.ListinoStore": [],
  "Infocar.store.LogicaStore": [],
  "Infocar.store.MarcaRicercaNuovoStore": [],
  "Infocar.store.MarcaRicercaUsatoStore": [],
  "Infocar.store.ModelloRicercaNuovoStore": [],
  "Infocar.store.ModelloRicercaUsatoStore": [],
  "Infocar.store.OrdinamentoRicercaNuovoStore": [],
  "Infocar.store.OrdinamentoRicercaStockStore": [],
  "Infocar.store.OrdinamentoRicercaUsatoStore": [],
  ...
  "Infocar.view.NuovoView": [],
  "Infocar.view.PhotoFullScreenPanel": [],
  "Infocar.view.StockView": [],
  "Infocar.view.TopBar": [],
